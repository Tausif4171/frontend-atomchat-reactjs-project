...
export default function ChatBox({ chat, ningthpage }) {
      ...
      return (
        ...
        >
          ...
          <div style={{textAlign:"center", color:"white"}}>
            {message.icon?message.icon:null}
        </div>
            {message?.replied_on && (
  ...
  return chat ? (
    <div className="chat-right" id="shift">
      ...
      <div className="flex-d jc-sb w-100" style={{ marginTop: 16 }}>
        <div style={{ width: "100%", marginBottom:-130 }}>{showChat()}</div>
        {/* <div>
        ...
        {ningthpage ? (
          <div className="flex-d jc-fe a-i-c w-100">
            ...
            <div style={{ height: 64,  }} className="flex jc-sb a-i-c" id="thirtyeight_chat_footer">
